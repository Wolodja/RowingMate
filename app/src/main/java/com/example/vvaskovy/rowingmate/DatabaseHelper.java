...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table Traning(idTreningu integer primary key autoincrement, sposobTreningu text not null, dataTreningu date not null );");

        db.execSQL("create table Interwal(idTreningu integer, nrInterwalu integer not null, czasInterwalu time not null," +
